...
public class Converter {
	 ...
	 */
	// ---------------------------------------------------------------------------------------------------
	public String addSpacesToString(String hex) {
	 ...
	 */
	// ----------------------------------------------------------------------------------------------------------
	public String byteToHex(byte[] requestPacket) {
		StringBuilder hexData = new StringBuilder();
		for (byte currByte : requestPacket) {
	...
	public String asciitoHex(String asciiValue) {		
		...
		try {
			...
			System.out.println("Ascii Value "+asciiValue+" was converted to hex value "+ hex);
		}catch(Exception e) {
			System.out.println("Unable to perform ascii to hex operation on value "+asciiValue);
		}		
		return hex.toString();
	}
	...
	public String binaryToHex(String bitmap) {
		...
		try {
			...
			System.out.println("Binary value "+bitmap+" was converted to hex value "+hexData.trim());
		}catch(Exception e) {
			System.out.println("Unable to convert the binary value "+bitmap+" to hex");
		}		
		return hexData.trim();
	}
